...
typedef void (*t_gotfn4)(void *x, void *arg1, void *arg2, void *arg3,
                         void *arg4);
#define mess4(x, s, a, b, c, d)                                                \
  ((*(t_gotfn4)getfn((x), (s)))((x), (a), (b), (c), (d)))
typedef void (*t_gotfn5)(void *x, void *arg1, void *arg2, void *arg3,
                         void *arg4, void *arg5);
...
EXTERN void binbuf_eval(const t_binbuf *x, t_pd *target, int argc,
                        const t_atom *argv);
...
EXTERN int binbuf_read(t_binbuf *b, const char *filename, const char *dirname,
                       int flag);
EXTERN int binbuf_read_via_canvas(t_binbuf *b, const char *filename,
                                  const t_canvas *canvas, int flag);
EXTERN int binbuf_read_via_path(t_binbuf *b, const char *filename,
                                const char *dirname, int flag);
EXTERN int binbuf_write(const t_binbuf *x, const char *filename,
...
PD_DEPRECATED EXTERN double
clock_getsystime(void); /* use clock_getlogicaltime() */
...
EXTERN t_class *pd_class_new(t_symbol *name, t_newmethod newmethod,
                             t_method freemethod, size_t size, int flags,
                             t_atomtype arg1, ...);
...
#define CLASS_MAINSIGNALIN(c, type, field)                                     \
  PD_STATIC_ASSERT(sizeof(((type *)NULL)->field) == sizeof(t_float),           \
...
EXTERN void obj_saveformat(const t_object *x,
                           t_binbuf *bb); /* add format to bb */
...
PD_DEPRECATED EXTERN void verbose(int level, const char *fmt, ...)
    ATTRIBUTE_FORMAT_PRINTF(2, 3); /* avoid this: use logpost() instead */
...
EXTERN void pd_queue_mess(struct _pdinstance *instance, t_pd *obj, void *data,
                          t_messfn fn);
...
PD_DEPRECATED EXTERN int
garray_getfloatarray(t_garray *x, int *size,
                     t_float **vec); /* use garray_getfloatwords() */
EXTERN int garray_getfloatwords(t_garray *x, int *size, t_word **vec);
EXTERN void garray_redraw(t_garray *x);
EXTERN int garray_npoints(t_garray *x);
EXTERN char *garray_vec(t_garray *x);
PD_DEPRECATED EXTERN void
garray_resize(t_garray *x, t_floatarg f); /* use garray_resize_long() */
...
PD_DEPRECATED EXTERN void
sys_vgui(const char *fmt, ...); /* avoid this: use pdgui_vmess() instead */
PD_DEPRECATED EXTERN void
sys_gui(const char *s); /* avoid this: use pdgui_vmess() instead */
...
PD_DEPRECATED EXTERN void
gfxstub_new(t_pd *owner, void *key,
            const char *cmd); /* avoid this: use pdgui_stub_vnew() instead */
PD_DEPRECATED EXTERN void gfxstub_deleteforkey(
    void *key); /* avoid this: use pdgui_stub_deleteforkey() instead */
 ...
 *    'p' : <int:size> <const char*:values>  : a pascal string (explicit size;
 not \0-terminated)
...
EXTERN void pdgui_stub_vnew(t_pd *owner, const char *destination, void *key,
                            const char *fmt, ...);
...
PD_INLINE unsigned int _sys_getversioncode(int *major, int *minor,
                                           int *bugfix) {
  int a, b, c;
